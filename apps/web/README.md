...
AI 코딩 에이전트(Claude Code, Codex 등)의 사용량을 로컬 `token-agent`가
집계한 뒤 Supabase에 업로드한 `usage_daily` 데이터를 보여주는 Next.js 웹
대시보드입니다.

Production: https://countoken.com
...
Vercel Project는 GitHub repository `jtlee91/countoken`에 연결하고,
